...
#
# Use this after tuning HUB_SIZE_RATIO in .env, or hand-editing a
# special-demand JSON file (raw_map_files/CITY_CODE/.railyard_map/
# special_demand_points.json) - it skips the much slower OSM parsing /
# airport snapping / base OSRM routing steps and just re-runs
# cluster/consolidate + named special demand against the existing base
# checkpoint (raw_map_files/CITY_CODE/demand_data_base.json), then saves the
# result to demand_data.json - same file run_demand_pipeline.py's full run
# writes.
#
